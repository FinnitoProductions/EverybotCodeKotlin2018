...
object OI {
    ...
    init {
        //driver arm buttons
        driverGamepad.buttonA.whenPressed(MoveArmPosition(Arm.MAX_POSITION_DOWN_SPEED, ArmSubsystem.ArmDirection.DOWN))
        driverGamepad.buttonY.whenPressed(MoveArmPosition(Arm.MAX_POSITION_UP_SPEED, ArmSubsystem.ArmDirection.UP))

        //operator arm buttons
        operatorGamepad.buttonA.whenPressed(MoveArmPosition(Arm.MAX_POSITION_DOWN_SPEED, ArmSubsystem.ArmDirection.DOWN))
        operatorGamepad.buttonY.whenPressed(MoveArmPosition(Arm.MAX_POSITION_UP_SPEED, ArmSubsystem.ArmDirection.UP))
